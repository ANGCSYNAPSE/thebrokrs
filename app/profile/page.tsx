  ...
  return (
    <main className="min-h-screen pt-28 pb-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container relative z-10 max-w-6xl mx-auto px-4 md:px-6">
        ...
        {/* Page Header */}
        <div className="mb-10">
          <h1 className="text-3xl md:text-4xl font-display font-bold text-brand-950">
            My Profile
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
          ...
          <div className="space-y-6">
            <div className="rounded-[24px] border border-cyan-100 bg-white/80 p-6 shadow-[0_8px_30px_rgba(8,145,178,0.06)] backdrop-blur-xl">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-brand-950">John Doe</h3>
                <p className="text-sm text-brand-500">Premium Investor</p>
                <div className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-cyan-50 px-3 py-1 border border-cyan-100">
                  <span className="h-2 w-2 rounded-full bg-green-500 animate-pulse" />
                  <span className="text-[10px] font-bold uppercase tracking-widest text-cyan-700">Verified</span>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100">
                <button className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-red-500 hover:bg-red-50 font-medium transition-colors">
          ...
          <div className="space-y-8">
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="rounded-[24px] border border-cyan-100 bg-white/80 p-6 shadow-sm backdrop-blur-xl relative overflow-hidden group">
                      ...
                      <div className="flex justify-between items-start relative z-10">
                        <div>
                          ...
                          <h3 className="text-3xl font-display font-bold text-brand-950">₹14,50,000</h3>
                        </div>
                      ...
                      <div className="mt-4 flex items-center gap-2 text-sm">
                        ...
                        <span className="text-emerald-500 font-bold">+18.5%</span>
                        <span className="text-brand-400">vs last year</span>
                      </div>
                    </div>
                    ...
                    <div className="rounded-[24px] border border-cyan-100 bg-white/80 p-6 shadow-sm backdrop-blur-xl relative overflow-hidden group">
                      ...
                      <div className="flex justify-between items-start relative z-10">
                        <div>
                          ...
                          <h3 className="text-3xl font-display font-bold text-brand-950">2</h3>
                        </div>
                      ...
                      <div className="mt-4 text-sm text-brand-400">
                        <span className="text-sky-600 font-bold">1</span> upcoming milestone
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[24px] border border-cyan-100 bg-white/80 p-6 md:p-8 shadow-sm backdrop-blur-xl">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <Button variant="outline" className="h-9 rounded-full border-cyan-200 text-cyan-700 hover:bg-cyan-50" onClick={() => setActiveTab("settings")}>
                        Edit
                      </Button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
                      <div>
                        ...
                        <p className="font-semibold text-brand-900">John Doe</p>
                      </div>
                      <div>
                        <div className="flex items-center gap-2 text-brand-400 mb-1">
                        ...
                        <p className="font-semibold text-brand-900">john.doe@example.com</p>
                      </div>
                      <div>
                        <div className="flex items-center gap-2 text-brand-400 mb-1">
                        ...
                        <p className="font-semibold text-brand-900">+91 98765 43210</p>
                      </div>
                      <div>
                        <div className="flex items-center gap-2 text-brand-400 mb-1">
                        ...
                        <p className="font-semibold text-brand-900">Mumbai, India</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-brand-950 uppercase tracking-wider ml-1">First Name</label>
                      <Input defaultValue="John" className="h-12 rounded-xl border-slate-200" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-brand-950 uppercase tracking-wider ml-1">Last Name</label>
                      <Input defaultValue="Doe" className="h-12 rounded-xl border-slate-200" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-brand-950 uppercase tracking-wider ml-1">Email Address</label>
                      <Input defaultValue="john.doe@example.com" type="email" className="h-12 rounded-xl border-slate-200" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-brand-950 uppercase tracking-wider ml-1">Phone Number</label>
                      <Input defaultValue="+91 98765 43210" className="h-12 rounded-xl border-slate-200" />
                    </div>
                  </div>

                  <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                    <Button variant="ghost" className="rounded-xl h-12 px-6">Cancel</Button>
              ...
              {/* Add placeholders for other tabs to keep it complete */}
